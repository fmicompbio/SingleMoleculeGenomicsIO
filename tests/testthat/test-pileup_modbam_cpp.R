test_that("pileup_modbam_cpp works", {
    ...
    bam4 <- system.file("extdata", "6mA_simple.bam", package = "SingleMoleculeGenomicsIO")
    bam5 <- system.file("extdata", "6mA_nonPrimary.bam", package = "SingleMoleculeGenomicsIO")
    bam7 <- system.file("extdata", "6mA_mod-issue.bam", package = "SingleMoleculeGenomicsIO")
    bam8 <- system.file("extdata", "6mA_too-many-mods.bam", package = "SingleMoleculeGenomicsIO")
    bam9 <- system.file("extdata", "6mA_two-mods-on-same-base.bam", package = "SingleMoleculeGenomicsIO")
    ...
    expect_error(pileup_modbam_cpp(inname_str = bam8, regions = "chr1",
                 ...
                 "More modifications than SingleMoleculeGenomicsIO")
    ...
    aln6a <- Rsamtools::scanBam(file = modbamfile,
                                param = Rsamtools::ScanBamParam(
                                    what = "qname",
                                    which = GenomicRanges::GRanges("chr1:6941000-6941001")
                                ))
    aln6b <- Rsamtools::scanBam(file = modbamfile,
                                param = Rsamtools::ScanBamParam(
                                    what = "qname",
                                    which = GenomicRanges::GRanges(c("chr1:6941000-6941001", "chr1:6928000-6928001"))
                                ))
...
test_that("pileup_modbam_cpp works by comparing to read_modbam_cpp", {
    ...
    # ... expected results
    modbamfile <- system.file("extdata", "6mA_2_10reads.bam", package = "SingleMoleculeGenomicsIO")
