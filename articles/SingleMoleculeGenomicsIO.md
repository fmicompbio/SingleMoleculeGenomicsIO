...
#> ✔ finding unique genomic positions... [118ms]
#> 
#> ℹ collapsed 17739 positions to 7967 unique ones
#> ✔ collapsed 17739 positions to 7967 unique ones [322ms]
#> 
se
...
#> ✔ collapsed 11211 positions to 7967 unique ones [64ms]
#> 
se_summary2
#> class: RangedSummarizedExperiment 
#> dim: 7967 2 
...
#> ✔ collapsed 31912 positions to 7238 unique ones [201ms]
#> 
se_sample$n_reads
#> [1] 5 7
```
...
#> ─ Session info ───────────────────────────────────────────────────────────────
#>  setting  value
#>  version  R Under development (unstable) (2025-11-24 r89053)
...
#>  Biostrings               * 2.79.2     2025-11-12 [1] Bioconductor 3.23 (R 4.6.0)
...
#>  S4Arrays                 * 1.11.1     2025-12-03 [1] Github (Bioconductor/S4Arrays@b7ddb8c)
...
#>  SingleMoleculeGenomicsIO * 0.1.0      2025-12-03 [1] Bioconductor
#>  SparseArray              * 1.11.8     2025-12-03 [1] Github (Bioconductor/SparseArray@513682b)
...
#>  yaml                       2.3.11     2025-11-28 [1] CRAN (R 4.6.0)
#> 
